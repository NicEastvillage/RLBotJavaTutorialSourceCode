 ...
 *
 * Look inside Goblin.java for the actual bot logic!
 */
public class GoblinMain {

    private static final Integer DEFAULT_PORT = 17844;
    ...
    public static void main(String[] args) {
        ...
        GoblinPythonInterface pythonInterface = new GoblinPythonInterface(port, botManager);
        ...
        dataPanel.add(new JLabel("I'm the thing controlling the Goblin(s), keep me open :)"), BorderLayout.CENTER);
        JLabel botsRunning = new JLabel("Bots running: ");
        dataPanel.add(botsRunning, BorderLayout.CENTER);
        panel.add(dataPanel, BorderLayout.CENTER);
        frame.add(panel);

        URL url = GoblinMain.class.getClassLoader().getResource("icon.png");
